...
Ветвления в Git нужны для создания черновиков , с последующим добавлением в оригинал.
...
Чтобы удалить ветку которая больше не нужна , используй команду :

    git branch -d <name>

Где ***name*** имя ветки которую удаляем. 

## Удаленные репозитории
Удаленнные репозитории нужны для того чтобы ...
